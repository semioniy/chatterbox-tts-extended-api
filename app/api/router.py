...
api_router.include_router(voices.base_router, prefix="/v1/audio", tags=["Voice Library @/v1/audio"])
api_router.include_router(health.base_router, tags=["Health"])
api_router.include_router(models.base_router, tags=["Models"])
api_router.include_router(models.base_router, prefix="/v1/audio", tags=["Models @/v1/audio"])
